...
export default function Home() {
  return (
    <main
      style={tajawal.style}
      className="flex h-full overflow-hidden flex-col bg-[#136352] text-white"
    >
      <div className="flex py-4 mx-5">
        ...
        {/* <Image
          src="/icons/mabaat-green-long.png"
          width={120}
          height={100}
          alt="logo"
          className="mx-auto"
      ...
      <div className="flex-row-reverse mx-5 flex h-[3.7rem] rounded-full bg-black/10">
        <div className="h-full aspect-square flex">
          <MdOutlineSearch className="m-auto w-full h-2/5" />
        </div>
        ...
        <div className="h-full aspect-square flex">
          <div className="w-[70%]  aspect-square m-auto flex border border-[#cedfc3] rounded-full">
      ...
      <div
        ...
        className="flex flex-col flex-1 overflow-hidden mt-6 bg-white rounded-t-[3rem] text-black"
      >
        <PropertiesList />
      </div>
    </main> //bg-[#376767]
